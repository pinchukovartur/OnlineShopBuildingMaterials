...
import myproject.service.user.UserService;
...
public class ViewController {
    ...
    public ModelAndView main(ModelAndView modelAndView, Principal user, HttpServletRequest servletRequest) {
        if(user!=null){
            modelAndView.addObject("productsInBasket", userService.getAllTheMaterialsOfThisUser(user.getName()).size());
        }
        System.out.println(servletRequest.getRealPath("/"));
    ...
    public ModelAndView registration(ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("WEB-INF/jsp/" + "registration");
        return modelAndView;
    }

    @RequestMapping(value = "/basket", method = RequestMethod.GET)
    public ModelAndView basket(ModelAndView modelAndView, Principal user) {
        modelAndView.setViewName("WEB-INF/jsp/" + "basket");
            ...
            ModelAndView modelAndView, Principal user)
    {
        ...
        modelAndView.setViewName("WEB-INF/jsp/" + "catalog");
        return modelAndView;
    }
    ...
    public ModelAndView oneProduct(@PathVariable("id") String idProduct, ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("WEB-INF/jsp/" + "one_product");
        return modelAndView;
    }
